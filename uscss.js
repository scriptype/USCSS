...
define('declaration',["utils"], function (Utils) {
...
require(["declaration"], function (Declaration) {
    ...
    var USOUTPUT = new Declaration(USCSS)
    USOUTPUT.getOutput()

    console.log(USOUTPUT)
    console.log("--------")
    console.log(USOUTPUT.input)
    console.log("--------")
    console.log(USOUTPUT.output)
});
define("uscss", function(){});
